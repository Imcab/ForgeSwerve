package lib.Forge.REV.SparkMax;
...
public class ForgeSparkMax extends SparkMax implements Sendable{
    ...
    public ForgeSparkMax(int deviceID) {
        ...
        this.encoder = super.getAlternateEncoder();
    }
    ...
    public void initSendable(SendableBuilder builder){
        ...
        builder.addDoubleProperty("appliedSpeed", ()-> super.get(), null);

        builder.addDoubleProperty("appliedVoltage", ()-> super.getBusVoltage(), null);
